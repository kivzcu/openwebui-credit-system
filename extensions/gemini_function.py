...
class Pipe:
    ...
    async def _handle_streaming_response(
        ...
        prompt_tokens = completion_tokens = thinking_tokens = total_tokens = cached_tokens = None
        ...
        try:
            ...
            usage_dict = self._build_usage_dict(prompt_tokens, completion_tokens, thinking_tokens, cached_tokens, total_tokens)
            if usage_dict:
    ...
    def _build_usage_dict(self, prompt_tokens, completion_tokens, thinking_tokens, cached_tokens, total_tokens):
